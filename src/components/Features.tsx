      ...
      <div className="mx-auto px-4">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature) => (
            <div
              key={feature.id}
              className="p-6 bg-neutral-950 rounded-lg shadow-sm flex flex-col items-center"
            >
              <div className="w-20 h-20 rounded-full flex items-center justify-center bg-sky-100">
                {feature.icon}
              </div>

              <h3 className="text-xl font-semibold text-sky-500 mt-6 text-center">
                {feature.name}
              </h3>
